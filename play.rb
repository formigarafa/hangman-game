class Hangman
    ...
    def initialize
        ...
        # inicializando com string contendo "_" * 
        @word_teaser = "_" * @challenge[:word].size
    end
    ...
    def print_teaser last_guess = nil
        ...
        # Formata com espaços entre as letras ao imprimir
        puts @word_teaser.split("").join(" ")
    end
    ...
    def update_teaser last_guess
        ...
        #dá a word_teaser as novas palvaras
